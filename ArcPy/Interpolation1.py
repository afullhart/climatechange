...
# with arcpy.EnvManager(outputCoordinateSystem='GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]]', snapRaster="DEM.tif", extent='-121.000373825047 29.9992389131714 -101.999208935351 43.0005560202333 GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]]', scratchWorkspace=r"C:\Users\afullhart\Documents\ArcGIS\Projects\MyProject\MyProject.gdb"):
#     output_raster = arcpy.sa.RasterCalculator(
#         expression='Power("DEM.tif",0)'
#     )
#     output_raster.save(r"C:\Users\afullhart\Documents\ArcGIS\Projects\MyProject\MyProject.gdb\RasterC_1")
