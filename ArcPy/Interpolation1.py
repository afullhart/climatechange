...
for io in map_io_data:
  ...
  #arcpy.env.mask = os.path.join(dataDIR, 'Study_Area_Shp', 'Study_Area_Shp.shp')
  ...
  #     in_raster='TEST',
  #     in_mask_data=os.path.join(dataDIR, 'Study_Area_Shp', 'Study_Area_Shp.shp'),
  #     extraction_area="INSIDE",
  #     analysis_extent='-119.996324684 31.335634021 -102.997400997 42.0023005790001 GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]]'
  # )
  
  # out_raster.save(ground.strip('.txt'))
