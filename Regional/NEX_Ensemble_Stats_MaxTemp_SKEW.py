...
out_file = '/content/drive/MyDrive/Colab Notebooks/NEX_Ensemble_Stats_MaxTemp_SKEW.csv'
...
reducer_str_list = ee.List(['tasmax_skew_p25', 'tasmax_skew_p75', 'tasmax_skew_min', 'tasmax_skew_max', 'tasmax_skew_mean'])
  ...
  def window_fn(winyear):
    ...
    def reduce_fn(model_i):
      ...
      mean_dict = re_im.reduceRegion(
        ...
        scale=500,
        maxPixels=1e10)
      avg_stat = mean_dict.get('tasmax_skew')
      return avg_stat
