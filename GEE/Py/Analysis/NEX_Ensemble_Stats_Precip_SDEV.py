...
out_file = '/content/drive/MyDrive/Colab Notebooks/NEX_Ensemble_Stats_Precip_SDEV.csv'
...
reducer_str_list = ee.List(['pr_stdDev_p25', 'pr_stdDev_p75', 'pr_stdDev_min', 'pr_stdDev_max', 'pr_stdDev_mean'])
